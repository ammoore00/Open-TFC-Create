onEvent('recipes', event => {
    ...
    event.replaceInput({output: 'createaddition:electric_motor'}, '#forge:rods/iron', 'create:shaft')
    ...
    event.replaceInput({output: 'createaddition:alternator'}, '#forge:rods/iron', 'create:shaft')
